                    ...
                    {subTasks.length === 0 ? (
                      ...
                      <div className="flex gap-2 md:gap-3 min-w-0">
                        {subTasks.map((subTask) => (
                          <div
                            key={subTask.id_task}
                            className="bg-white rounded-md md:rounded-lg border border-gray-200 hover:border-gray-300 transition-all duration-200 hover:shadow-sm flex-shrink-0 min-w-[280px] md:min-w-[320px]"
                          >
                            <SubTaskItem
                              subTask={subTask}
                ...
                <Panel defaultSize={30} minSize={20}>
                  <div className="h-full bg-white overflow-auto">
                    <div className="w-96 bg-gray-50 border-l border-gray-200 flex flex-col h-full">
                      ...
                      {/* Add Comment Section */}
                      <div className="border-t border-gray-200 bg-white px-6 py-4 space-y-3 z-10">
